...
func TestMain(m *testing.M) {
	...
	mailerConfig := mailer.MailConfig{
		Domain:      "localhost", // Ideally, fetch from environment variables or flags
		Host:        "localhost",
		Port:        1025,
		Username:    "", // Set if needed, possibly from flags or environment
		Password:    "", // Set if needed, possibly from flags or environment
		Encryption:  "none",
